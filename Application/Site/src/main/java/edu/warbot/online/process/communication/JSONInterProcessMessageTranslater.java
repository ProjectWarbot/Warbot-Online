...
import edu.warbot.online.process.communication.client.*;
import edu.warbot.online.process.communication.server.LaunchGameCommand;
import edu.warbot.online.process.communication.server.PreciseAgentCommand;
import edu.warbot.online.process.communication.server.RemoteConsoleCommand;
import edu.warbot.online.process.communication.server.RemoteWarbotCommand;
...
public class JSONInterProcessMessageTranslater {
     ...
     * @param message
     * @return
     * @throws UnrecognizedInterProcessMessageException
     * @throws IOException
     */
