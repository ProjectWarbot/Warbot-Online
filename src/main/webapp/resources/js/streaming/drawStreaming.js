...
function addWheelListener() {
	...
	container.addEventListener('onmousewheel', cameraZoom);
	// Firefox
	container.addEventListener("DOMMouseScroll", cameraZoom, false);
	}
	// IE 6/7/8
	else container.addEventListener("onmousewheel", cameraZoom);
}
