    ...
    create table TEST_ZONE (
        id bigint generated by default as identity (start with 1),
        test_zone_description varchar(255),
        test_zone_level integer,
        test_zone_name varchar(255),
        creator_id bigint,
        primary key (id)
    );
    ...
    alter table TEST_ZONE 
        add constraint UK_qq8aq9qa2xa52femdb36e5dxe  unique (test_zone_name);
    ...
    alter table TEST_ZONE 
        add constraint FK_qvptghvyphxlw77remwym9h8s 
        foreign key (creator_id) 
        references ACCOUNT;
